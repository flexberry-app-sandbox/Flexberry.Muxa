    ...
    public class City : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View CityE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CityE", typeof(IIS.Muxa.City));
                }
            }
            ...
            public static ICSSoft.STORMNET.View CityL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CityL", typeof(IIS.Muxa.City));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ГородE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ГородE", typeof(IIS.Muxa.City));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ГородL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ГородL", typeof(IIS.Muxa.City));
                }
            }
        }
    }
